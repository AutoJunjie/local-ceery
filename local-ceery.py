...
class VoiceChatbot:
    ...
    def transcribe(self, audio_bytes: bytes) -> str:
        ...
        Optimized: uses in-memory BytesIO instead of temporary file.
        """
        if not audio_bytes:
            return ""
        ...
        # Use BytesIO directly - no disk I/O needed
        audio_file = io.BytesIO(audio_bytes)
        audio_file.name = "audio.wav"  # OpenAI SDK needs filename to detect format
